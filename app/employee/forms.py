...
class EmployeeForm(FlaskForm):
    first_name = StringField('First name', [DataRequired(), validators.Length(min=1, max=70), validators.Regexp('^[a-zA-Z\- ]+$', message='First name must only contain alphabetic characters and hyphens')])
